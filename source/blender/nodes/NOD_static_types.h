...
DefNode(GeometryNode, GEO_NODE_RANDOMIZED_OBJECT_INFO, def_geo_randomized_object_info, "RANDOMIZED_OBJECT_INFO", RandomizedObjectInfo, "Randomized Object Info", "")
